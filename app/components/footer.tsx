      ...
      <ul className="font-sm mt-8 flex flex-col space-x-0 space-y-2 text-neutral-600 md:flex-row md:space-x-4 md:space-y-0 dark:text-neutral-300">
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://telegram.me/tobeycodes"
          >
            <ArrowIcon />
        ...
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://cal.com/tobeycodes/15min"
          >
            <ArrowIcon />
            <p className="ml-2 h-7">schedule time</p>
          </a>
        </li>
        <li>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            href="https://github.com/tobeycodes"
          >
            <ArrowIcon />
